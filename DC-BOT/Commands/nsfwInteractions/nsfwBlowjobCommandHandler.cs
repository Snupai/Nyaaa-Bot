...
namespace DC_BOT.Commands
{
    internal class nsfwBlowjobCommandHandler : ICommandHandler
    {
        ...
        public async Task HandleAsync(SocketSlashCommand command)
        {
            ...
            {
                string result;
                var url = "https://gallery.fluxpoint.dev/api/nsfw/gif/blowjob";
            ...
            {
                await this._logger.Log(new LogMessage(LogSeverity.Info, "CommandHandler : nsfwBlowjobCommandHandler", $"Bad request {e.Message}, Command: i-blowjob", null)); //WriteLine($"Error: {e.Message}");
        ...
        public SlashCommandProperties Initialize()
        {
            ...
            globalCommandnsfwBlowjob.WithName("i-blowjob");
            globalCommandnsfwBlowjob.WithDescription("blowjob.");
            globalCommandnsfwBlowjob.AddOption("user", ApplicationCommandOptionType.User, "Choose a user.", isRequired: true); //idk
