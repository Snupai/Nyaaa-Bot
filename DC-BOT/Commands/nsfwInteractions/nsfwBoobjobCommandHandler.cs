...
{
    internal class nsfwBoobjobCommandHandler : ICommandHandler
    {
        ...
        public nsfwBoobjobCommandHandler(ILogger logger)
        {
        ...
        public async Task HandleAsync(SocketSlashCommand command)
        {
            ...
            {
                string result;
                var url = "https://gallery.fluxpoint.dev/api/nsfw/gif/boobjob";
            ...
            {
                await this._logger.Log(new LogMessage(LogSeverity.Info, "CommandHandler : nsfwBoobjobCommandHandler", $"Bad request {e.Message}, Command: i-boobjob", null)); //WriteLine($"Error: {e.Message}");
        ...
        {
            SlashCommandBuilder globalCommandnsfwBoobjob = new SlashCommandBuilder();
            globalCommandnsfwBoobjob.WithName("i-boobjob");
            globalCommandnsfwBoobjob.WithDescription("boobjob.");
            globalCommandnsfwBoobjob.AddOption("user", ApplicationCommandOptionType.User, "Choose a user.", isRequired: true); //idk
            globalCommandnsfwBoobjob.IsNsfw = true;
            return globalCommandnsfwBoobjob.Build();
        }
    }
}
