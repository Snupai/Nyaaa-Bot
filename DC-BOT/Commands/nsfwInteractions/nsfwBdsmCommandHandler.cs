...
namespace DC_BOT.Commands
{
    internal class nsfwBdsmCommandHandler : ICommandHandler
    {
        ...
        public async Task HandleAsync(SocketSlashCommand command)
        {
            ...
            {
                string result;
                var url = "https://gallery.fluxpoint.dev/api/nsfw/gif/bdsm";
            ...
            {
                await this._logger.Log(new LogMessage(LogSeverity.Info, "CommandHandler : nsfwBdsmCommandHandler", $"Bad request {e.Message}, Command: i-bdsm", null)); //WriteLine($"Error: {e.Message}");
        ...
        public SlashCommandProperties Initialize()
        {
            ...
            globalCommandnsfwBdsm.WithName("i-bdsm");
            globalCommandnsfwBdsm.WithDescription("bdsm.");
            globalCommandnsfwBdsm.AddOption("user", ApplicationCommandOptionType.User, "Choose a user.", isRequired: true); //idk
