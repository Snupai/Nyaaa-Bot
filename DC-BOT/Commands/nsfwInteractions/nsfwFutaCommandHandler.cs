...
namespace DC_BOT.Commands
{
    internal class nsfwFutaCommandHandler : ICommandHandler
    {
        ...
        public async Task HandleAsync(SocketSlashCommand command)
        {
            ...
            {
                string result;
                var url = "https://gallery.fluxpoint.dev/api/nsfw/gif/futa";
            ...
            {
                await this._logger.Log(new LogMessage(LogSeverity.Info, "CommandHandler : nsfwFutaCommandHandler", $"Bad request {e.Message}, Command: i-futa", null)); //WriteLine($"Error: {e.Message}");
        ...
        public SlashCommandProperties Initialize()
        {
            ...
            globalCommandnsfwFuta.WithName("i-futa");
            globalCommandnsfwFuta.WithDescription("futa.");
            globalCommandnsfwFuta.AddOption("user", ApplicationCommandOptionType.User, "Choose a user.", isRequired: true); //idk
