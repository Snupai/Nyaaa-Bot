...
namespace DC_BOT.Commands
{
    internal class nsfwKitsuneCommandHandler : ICommandHandler
    {
        ...
        public async Task HandleAsync(SocketSlashCommand command)
        {
            ...
            {
                string result;
                var url = "https://gallery.fluxpoint.dev/api/nsfw/gif/kitsune";
            ...
            {
                await this._logger.Log(new LogMessage(LogSeverity.Info, "CommandHandler : nsfwKitsuneCommandHandler", $"Bad request {e.Message}, Command: i-kitsune", null)); //WriteLine($"Error: {e.Message}");
        ...
        public SlashCommandProperties Initialize()
        {
            ...
            globalCommandnsfwKitsune.WithName("i-kitsune");
            globalCommandnsfwKitsune.WithDescription("kitsune.");
            globalCommandnsfwKitsune.AddOption("user", ApplicationCommandOptionType.User, "Choose a user.", isRequired: true); //idk
