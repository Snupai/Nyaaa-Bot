...
namespace DC_BOT.Commands
{
    internal class nsfwFeetCommandHandler : ICommandHandler
    {
        ...
        public async Task HandleAsync(SocketSlashCommand command)
        {
            ...
            {
                string result;
                var url = "https://gallery.fluxpoint.dev/api/nsfw/gif/feet";
            ...
            {
                await this._logger.Log(new LogMessage(LogSeverity.Info, "CommandHandler : nsfwFeetCommandHandler", $"Bad request {e.Message}, Command: i-feet", null)); //WriteLine($"Error: {e.Message}");
        ...
        public SlashCommandProperties Initialize()
        {
            ...
            globalCommandnsfwFeet.WithName("i-feet");
            globalCommandnsfwFeet.WithDescription("feet.");
            globalCommandnsfwFeet.AddOption("user", ApplicationCommandOptionType.User, "Choose a user.", isRequired: true); //idk
