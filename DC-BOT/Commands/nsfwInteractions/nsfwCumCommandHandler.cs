...
namespace DC_BOT.Commands
{
    internal class nsfwCumCommandHandler : ICommandHandler
    {
        ...
        public async Task HandleAsync(SocketSlashCommand command)
        {
            ...
            {
                string result;
                var url = "https://gallery.fluxpoint.dev/api/nsfw/gif/cum";
            ...
            {
                await this._logger.Log(new LogMessage(LogSeverity.Info, "CommandHandler : nsfwCumCommandHandler", $"Bad request {e.Message}, Command: i-cum", null)); //WriteLine($"Error: {e.Message}");
        ...
        public SlashCommandProperties Initialize()
        {
            ...
            globalCommandnsfwCum.WithName("i-cum");
            globalCommandnsfwCum.WithDescription("cum.");
            globalCommandnsfwCum.AddOption("user", ApplicationCommandOptionType.User, "Choose a user.", isRequired: true); //idk
