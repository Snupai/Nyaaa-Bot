...
namespace DC_BOT.Commands
{
    internal class nsfwAssCommandHandler : ICommandHandler
    {
        ...
        public async Task HandleAsync(SocketSlashCommand command)
        {
            ...
            {
                string result;
                var url = "https://gallery.fluxpoint.dev/api/nsfw/gif/ass";
            ...
            {
                await this._logger.Log(new LogMessage(LogSeverity.Info, "CommandHandler : nsfwAssCommandHandler", $"Bad request {e.Message}, Command: i-ass", null)); //WriteLine($"Error: {e.Message}");
        ...
        public SlashCommandProperties Initialize()
        {
            ...
            globalCommandnsfwAss.WithName("i-ass");
            globalCommandnsfwAss.WithDescription("ass.");
            globalCommandnsfwAss.AddOption("user", ApplicationCommandOptionType.User, "Choose a user.", isRequired: true); //idk
