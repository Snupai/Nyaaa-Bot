...
namespace DC_BOT.Commands
{
    internal class nsfwTentacleCommandHandler : ICommandHandler
    {
        ...
        public async Task HandleAsync(SocketSlashCommand command)
        {
            ...
            {
                string result;
                var url = "https://gallery.fluxpoint.dev/api/nsfw/gif/tentacle";
            ...
            {
                await this._logger.Log(new LogMessage(LogSeverity.Info, "CommandHandler : nsfwTentacleCommandHandler", $"Bad request {e.Message}, Command: i-tentacle", null)); //WriteLine($"Error: {e.Message}");
        ...
        public SlashCommandProperties Initialize()
        {
            ...
            globalCommandnsfwTentacle.WithName("i-tentacle");
            globalCommandnsfwTentacle.WithDescription("tentacle.");
            globalCommandnsfwTentacle.AddOption("user", ApplicationCommandOptionType.User, "Choose a user.", isRequired: true); //idk
