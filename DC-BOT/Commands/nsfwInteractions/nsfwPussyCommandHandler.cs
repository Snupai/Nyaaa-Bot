...
namespace DC_BOT.Commands
{
    internal class nsfwPussyCommandHandler : ICommandHandler
    {
        ...
        public async Task HandleAsync(SocketSlashCommand command)
        {
            ...
            {
                string result;
                var url = "https://gallery.fluxpoint.dev/api/nsfw/gif/pussy";
            ...
            {
                await this._logger.Log(new LogMessage(LogSeverity.Info, "CommandHandler : nsfwPussyCommandHandler", $"Bad request {e.Message}, Command: i-pussy", null)); //WriteLine($"Error: {e.Message}");
        ...
        public SlashCommandProperties Initialize()
        {
            ...
            globalCommandnsfwPussy.WithName("i-pussy");
            globalCommandnsfwPussy.WithDescription("pussy.");
            globalCommandnsfwPussy.AddOption("user", ApplicationCommandOptionType.User, "Choose a user.", isRequired: true); //idk
