...
namespace DC_BOT.Commands
{
    internal class nsfwBoobsCommandHandler : ICommandHandler
    {
        ...
        public async Task HandleAsync(SocketSlashCommand command)
        {
            ...
            {
                string result;
                var url = "https://gallery.fluxpoint.dev/api/nsfw/gif/boobs";
            ...
            {
                await this._logger.Log(new LogMessage(LogSeverity.Info, "CommandHandler : nsfwBoobsCommandHandler", $"Bad request {e.Message}, Command: i-boobs", null)); //WriteLine($"Error: {e.Message}");
        ...
        public SlashCommandProperties Initialize()
        {
            ...
            globalCommandnsfwBoobs.WithName("i-boobs");
            globalCommandnsfwBoobs.WithDescription("boobs.");
            globalCommandnsfwBoobs.AddOption("user", ApplicationCommandOptionType.User, "Choose a user.", isRequired: true); //idk
