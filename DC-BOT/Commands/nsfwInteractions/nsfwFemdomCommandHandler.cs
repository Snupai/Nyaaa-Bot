...
namespace DC_BOT.Commands
{
    internal class nsfwFemdomCommandHandler : ICommandHandler
    {
        ...
        public async Task HandleAsync(SocketSlashCommand command)
        {
            ...
            {
                string result;
                var url = "https://gallery.fluxpoint.dev/api/nsfw/gif/femdom";
            ...
            {
                await this._logger.Log(new LogMessage(LogSeverity.Info, "CommandHandler : nsfwFemdomCommandHandler", $"Bad request {e.Message}, Command: i-femdom", null)); //WriteLine($"Error: {e.Message}");
        ...
        public SlashCommandProperties Initialize()
        {
            ...
            globalCommandnsfwFemdom.WithName("i-femdom");
            globalCommandnsfwFemdom.WithDescription("femdom.");
            globalCommandnsfwFemdom.AddOption("user", ApplicationCommandOptionType.User, "Choose a user.", isRequired: true); //idk
