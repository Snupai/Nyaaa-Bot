...
namespace DC_BOT.Commands
{
    internal class nsfwAnalCommandHandler : ICommandHandler
    {
        ...
        public async Task HandleAsync(SocketSlashCommand command)
        {
            ...
            {
                string result;
                var url = "https://gallery.fluxpoint.dev/api/nsfw/gif/anal";
            ...
            {
                await this._logger.Log(new LogMessage(LogSeverity.Info, "CommandHandler : nsfwAnalCommandHandler", $"Bad request {e.Message}, Command: i-anal", null)); //WriteLine($"Error: {e.Message}");
        ...
        public SlashCommandProperties Initialize()
        {
            ...
            globalCommandnsfwAnal.WithName("i-anal");
            globalCommandnsfwAnal.WithDescription("anal.");
            globalCommandnsfwAnal.AddOption("user", ApplicationCommandOptionType.User, "Choose a user.", isRequired: true); //idk
